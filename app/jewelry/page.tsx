    ...
    <main className="pt-[73px]">
      ...
      <section className="relative w-full h-[50vh] min-h-[360px] overflow-hidden bg-ink-plum">
        ...
        <div className="relative z-10 h-full flex flex-col justify-end px-5 md:px-margin-desktop pb-12 max-w-7xl mx-auto">
          <p className="font-manrope text-[11px] uppercase tracking-[0.18em] text-primary-container mb-3 stagger-up">Fine Jewelry</p>
          <h1 className="font-fraunces text-4xl md:text-6xl text-on-primary leading-tight stagger-up">Jewelry</h1>
        </div>
      </section>
